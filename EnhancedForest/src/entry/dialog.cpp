...
#    if BX_PLATFORM_LINUX
    ...
    bx::Error err;
    bx::write(&writer, &err, "--file-selection%s --title \"%.*s\" --filename \"%s\"",
        FileSelectionDialogType::Save == _type ? " --save" : "", _title.getLength(), _title.getPtr(), _inOutFilePath.getCPtr());
...
#    elif BX_PLATFORM_WINDOWS
    ...
    ofn.flags = 0 | /* OFN_EXPLORER        */ 0x00080000 | /* OFN_FILEMUSTEXIST   */ 0x00001000 | /* OFN_DONTADDTORECENT */ 0x02000000;
    ...
    if (err.isOk() && GetOpenFileNameA(&ofn)) {
